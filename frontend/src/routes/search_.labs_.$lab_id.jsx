...
export const Route = createFileRoute('/search_/labs_/$lab_id')({
...
function LabProfilePage() {
  ...
  if (error) {
    return (
      <div className="max-w-3xl mx-auto mt-10 p-4 bg-red-50 text-red-700 rounded-xl border border-red-100 text-center">
        {error}
      </div>
    )
  }
