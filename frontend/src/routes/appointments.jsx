        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 px-4 backdrop-blur-sm transition-opacity">
          <div className="bg-white rounded-2xl p-6 md:p-8 max-w-sm w-full shadow-2xl animate-fade-in-up text-center">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              ...
              <span className="font-bold">{cancelModalData.test_name}</span>{" "}
              scheduled for{" "}
              <span className="font-bold">
                {formatDateLabel(cancelModalData.appointment_date)}
              </span>
              ?
            </p>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500">
            Manage your upcoming diagnostic tests and view past reports.
          </p>
        </div>
        ...
        {currentList.length === 0 ? (
          <div className="bg-white p-12 rounded-2xl border border-gray-100 shadow-sm text-center">
            ...
            <p className="text-gray-500 mb-6">
              You don't have any {activeTab} diagnostic tests scheduled.
            </p>
            {activeTab === "upcoming" && (
              <Link
                to="/search"
                ...
                >
                  ...
                  {isMissed && (
                    <div className="bg-red-50 text-red-700 px-6 py-3 text-sm font-bold border-b border-red-100 flex items-center gap-2">
                      <span className="text-lg">⚠️</span> You did not visit the
                      lab for this appointment.
                    </div>
                  )}
